#!/usr/bin/env bash
# Provision ECHO inside a Docker container using Ansible (no Vagrant/VirtualBox needed).
#
# Usage:
#   ./iac/iac-docker.sh          # Start container, provision, verify
#   ./iac/iac-docker.sh destroy  # Remove the container
set -euo pipefail
